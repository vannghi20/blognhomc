...
<?php endif; ?>
		...
		<form method="post" class="woocommerce-form woocommerce-form-login login" role="form">
			...
			<p class="form-group form-row">
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'greenmart' ); ?>"><?php esc_html_e( 'Log in', 'greenmart' ); ?></button>
			</p>
